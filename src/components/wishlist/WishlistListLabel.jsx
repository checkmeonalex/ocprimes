import { getWishlistDisplayName, isDefaultWishlistName } from '@/lib/wishlist/list-name'

export default function WishlistListLabel({
  name,
  className = '',
  textClassName = '',
  iconClassName = 'h-4 w-4',
}) {
  const displayName = getWishlistDisplayName(name)
  const isDefault = isDefaultWishlistName(name)
