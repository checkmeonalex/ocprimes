...
export default function VendorSetPasswordForm() {
  ...
  if (!isReady) {
    return <p className='mt-6 text-sm text-slate-500'>Validating your secure link...</p>
  }

  if (!hasSession) {
    return (
      <p className='mt-6 text-sm text-rose-500'>
        This password setup link is invalid or expired. Ask admin to re-approve your vendor request.
      </p>
    )
  }
