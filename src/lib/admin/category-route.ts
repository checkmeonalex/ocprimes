...
export async function updateCategory(request: NextRequest) {
  ...
  if (parsed.data.size_guide_id !== undefined) {
    updates.size_guide_id = parsed.data.size_guide_id
  }
