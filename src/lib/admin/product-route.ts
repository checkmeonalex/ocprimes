...
export async function listProducts(request: NextRequest) {
  ...
  let query = db
    .from(PRODUCT_TABLE)
    .select('id, name, slug, short_description, description, price, discount_price, deal_expires_at, sku, sku_auto_generated, stock_quantity, status, product_type, condition_check, packaging_style, return_policy, main_image_id, product_video_key, product_video_url, created_at, updated_at')
