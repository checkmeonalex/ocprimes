...
const PRODUCT_LIST_FULL_SELECT =
  'id, name, slug, short_description, description, price, discount_price, deal_expires_at, sku, stock_quantity, initial_stock_quantity, status, product_type, condition_check, packaging_style, return_policy, main_image_id, show_low_stock_warning, product_video_key, product_video_url, created_at, updated_at, created_by'
const PRODUCT_LIST_CARD_SELECT =
  'id, name, slug, price, discount_price, deal_expires_at, sku, stock_quantity, initial_stock_quantity, status, product_type, main_image_id, show_low_stock_warning, product_video_url, created_at, created_by'
...
const withOptionalBrandColumns = async (supabase: any, brandId: string) => {
  const preferredSelect =
    'id, name, slug, logo_url, logo_full_url, logo_font, logo_size_desktop, logo_size_mobile, use_custom_profile_metrics, custom_profile_followers, custom_profile_sold, is_trusted_vendor, social_whatsapp, whatsapp_buy_enabled, social_instagram_url, social_instagram_handle, social_facebook_url, social_facebook_handle, social_x_url, social_x_handle, social_twitch_url, social_twitch_handle, social_tiktok_url, social_tiktok_handle, social_pinterest_url, social_pinterest_handle'
...
const attachVendorProfile = async (supabase: any, item: any) => {
  ...
  return {
    ...
    vendor_profile: {
      ...
      whatsapp_buy_enabled: Boolean(brandData?.whatsapp_buy_enabled),
