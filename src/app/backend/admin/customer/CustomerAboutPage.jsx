...
const ABOUT_META_KEYS = ['description'];
...
function WooCommerceCustomerAboutPage() {
  ...
  const loadCustomer = useCallback(async () => {
    ...
    try {
      ...
      const params = new URLSearchParams({
        ...
        user_meta_keys: ABOUT_META_KEYS.join(','),
      });
          ...
          <div className="mx-auto w-full max-w-6xl">
            ...
            <div className="mt-8 space-y-6">
              <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <p className="mt-1 text-xs text-slate-500">Upload a new avatar or remove the current photo.</p>
                <div className="mt-5 space-y-4">
                  <div className="flex items-center gap-4 rounded-2xl border border-slate-200 px-4 py-3">
                    {customer?.avatar_url ? (
                      ...
                      <span className="flex h-14 w-14 items-center justify-center rounded-full bg-slate-200 text-sm font-semibold text-slate-600">
              ...
              <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                {!isLoading && !error && (
                  <div className="mt-6 space-y-5">
                    <div>
                      <p className="text-sm font-semibold text-slate-700">Biographical info</p>
                    ...
                    <textarea
                      ...
                      placeholder="--"
                      rows={6}
                      className="w-full resize-none rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-700"
                    />
                  </div>
                )}
              </section>
...
export default WooCommerceCustomerAboutPage;
