...
export default function SellerConversationPlaceholder() {
  return (
    <section className="hidden h-full min-h-0 items-center justify-center bg-slate-50 lg:flex">
      <div className="mx-auto max-w-md text-center">
        ...
        <h2 className="mt-6 text-4xl font-semibold tracking-tight text-slate-900">Seller Messages</h2>
        <p className="mt-3 text-base text-slate-400">
          Handle buyer conversations, reply fast, and close sales from one workspace.
        </p>
        <p className="mt-16 text-xs text-slate-500">Your messages are visible only to your account.</p>
      </div>
    </section>
  );
}
