...
export const CONDITION_VALUES = ['brand_new', 'like_new', 'open_box', 'refurbished', 'handmade', 'okx']
export const PACKAGING_VALUES = ['in_wrap_nylon', 'in_a_box', 'premium_gift_packaging', 'cardboard_wrap']
export const RETURN_POLICY_VALUES = ['not_returnable', 'support_return']
export const STATUS_VALUES = ['publish', 'draft', 'archived']
...
export const uploadMediaInput = {
  file_path: z.string().describe('Absolute local file path to the image to upload'),
